...
class sys_plugin(Plugin):
	def __init__(self):
		...
		self.description="System plugin for silog"
	...
	def head(self,content,blog=None,*arg1,**arg2):
		content=content+'<meta name="generator" content="Silog %s" />'%blog.version
		return content

	def footer(self,content,blog=None,*arg1,**arg2):

		return content+'<!--Powered by silog %s-->'%blog.version
	...
	def get(self,page):
		return '''<h3>Sys Plugin</h3>
			   <p>This is a system plugin for silog. <br>Also a demo for how to write plugin for silog.</p>
			   <h4>feature</h4>
			   <p><ol>
			   <li>Add Meta &lt;meta name="generator" content="Silog x.x" /&gt;</li>
			   <li>Add footer "&lt;!--Powered by silog x.x--&gt;"</li>
