			...
			<body>
				...
				<div id="intro">
					<p>
						...
						It was generated using the Blogging-Software <a href="http://www.softwareinlife.com">Silog</a> .<br />
				...
				<div id="footer">
					Generated with <a href="http://silogdemo2.appspot.com/" title="Silog powered by google app engine">Silog</a> by <a href="http://www.softwareinlife.com">Software in Life</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
